...
*O grafo que os jobs de CI alimentam, na [interface visual](../README.md#interface-visual).*
...
Para o [grafo por área](../docs/areas.md): `GRAPH_AREA` e `GRAPH_TEAM` no grupo da área (ou no projeto) e
`GRAPH_HUB_URI`, `GRAPH_HUB_USER`, `GRAPH_HUB_PASSWORD` para exportar a fronteira para o hub. Sem elas, o job grava
só no `NEO4J_URI`.
